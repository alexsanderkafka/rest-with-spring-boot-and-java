...
import kafka.system.RestApi.Integrationtest.vo.PersonVOTest;
...
public class PersonControllerJsonTest extends AbstractIntegrationTest {
	...
	public void testCreate() throws IOException {
		...
		specification = new RequestSpecBuilder()
				.addHeader(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_ALEX)
	...
	public void testCreateWithWrongOrigin() throws IOException {
		...
		specification = new RequestSpecBuilder()
				.addHeader(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_KAFKA)
				.setBasePath("/api/person/v1")
				.setPort(TestConfigs.SERVER_PORT)
				.addFilter(new RequestLoggingFilter(LogDetail.ALL))
				.addFilter(new ResponseLoggingFilter(LogDetail.ALL))
